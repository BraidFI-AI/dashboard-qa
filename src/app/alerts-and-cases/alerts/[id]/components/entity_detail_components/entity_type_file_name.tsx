...
type EntityTypeFileNameComponentProps = {
  alert: Alert;
  context: Transaction[];
};

const EntityTypeFileNameComponent: React.FC<
  EntityTypeFileNameComponentProps
> = ({ alert, context }) => {
  return (
    <div
...
export default EntityTypeFileNameComponent;
