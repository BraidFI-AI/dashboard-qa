...
import { IndividualExternalAccount } from "@/core/api/ApiTypes";
import MyControlledAutocomplete from "@/core/components/Autocomplete/MyControlledAutocomplete";
import MyBlueButton from "@/core/components/Button/MyBlueButton";
import MyText from "@/core/components/Text/Text";
import MyControlledTextField from "@/core/components/TextField/MyControlledTextField";
import { createPaymentInstrument } from "@/redux/slices/IndividualSlice";
...
const CreateExternalAccountPage = () => {
  ...
  const {
    ...
    control,
    handleSubmit,
  } = useForm<IndividualExternalAccount>();
  const onSubmit: SubmitHandler<IndividualExternalAccount> = (data: any) => {
