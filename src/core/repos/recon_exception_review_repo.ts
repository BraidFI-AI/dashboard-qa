    ...
    if (transactionType == "ACH") {
      body = {
        ...
        transactionType: [
          ...
          "ACH_REVERSAL_CREDIT",
          "ACH_REVERSAL_DEBIT",
          "ACH_ORIGINATOR_IAT_CREDIT",
          "ACH_ORIGINATOR_IAT_DEBIT",
          "ACH_RETURNED_RECEIVER_DEBIT",
          "ACH_RECEIVER_CREDIT_RETURN",
          "ACH_RECEIVER_CREDIT_EXCEPTION",
          "ACH_RECEIVER_DEBIT_EXCEPTION",
          "ACH_DISHONORED_RETURN_CREDIT",
          "ACH_DISHONORED_RETURN_DEBIT",
        ],
      };
    } else {
      body = {
